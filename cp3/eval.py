"""
Evaluate the cp3 detector (continue_Teleport) on the validation set in cp3/vallabels
...
def main():
    ...
    ax.set_title("continue_Teleport — per-class metrics (val set)", fontsize=14)
